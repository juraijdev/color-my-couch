...
⚠️ ZERO-EXTRA-PARTS LOCK ⚠️
Do NOT add ANY part, element, or detail that does not already exist in the input photo. This is the strictest rule. Specifically you must NOT add: extra legs, extra shelves, extra drawers, extra doors, extra handles, extra knobs, extra hinges, extra dividers, extra trim strips, extra metal bands, extra lips, extra edges, extra panels, extra fascia, extra moldings, extra grooves, extra seams, extra cutouts, extra screens, extra inlays, extra fluting, extra borders, extra frames, extra hardware, extra casters/wheels, extra feet, extra brackets, extra supports, extra reflections, extra shadows, extra accessories, extra decorative ornaments, extra carved details, extra geometric patterns, or any new structural or decorative element of any kind. Count every leg, shelf, drawer, door, handle, divider, trim strip, panel, cutout, and edge in the input — the output must contain the SAME COUNT of each, in the SAME POSITION, with the SAME SHAPE and SAME SIZE. If you are tempted to add a detail to "complete" or "improve" the look, DO NOT. The furniture must look like the exact same physical object, only repainted. Adding any part that was not in the original is a WRONG result.
